...
the_registrant <- webpage %>% 
  ...
  html_text() #says "give me the text associated with the above node"
the_registrant
```
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant, #"!!" tells it to set as a variable, not a string
...
## the "!!" says look for an object called "the_registrant" and use that value instead of naming everything "the_registrant"
df_withdrawals <- data.frame("Month" = rep(1:12),
...
#Set the inputs to scrape years 2018 to 2020 for the site "0004-0001"
...
#Subset the facilities by a random sample of 20
