...
```{r}
#Apply the API key
census_api_key("dbee391cc19096b3b1e6d4a527e6f084912a99b2", install = TRUE, overwrite=TRUE)
...
state.electricity<-data.frame("State" = the_states,
                              "Year" = 2020,
                              "Price" = as.numeric(the_price),
                              "Capacity" = as.numeric(gsub(",","",the_capacity)),
                              "Net Generation" = as.numeric(gsub(",","",net_generation)),
